...
if (!$playlist_result) {
	...
	echo '<div class="w3-quarter">';
	echo '<div style="height:80%;text-align:center">';
	echo '<button onClick="newPlaylistOpen()"><i style="color:white" class="icono-plusCircle"></i></button>';
	echo '</div>';
	echo '</div>';
	
	echo '<div class="w3-sidebar w3-black w3-bar-block w3-card w3-animate-left" style="height: 75%; width:50%; display:none; z-index:3" id="newplaylist">';
	echo '<button class="w3-bar-item w3-button w3-large" onclick="newPlaylistClose()">Close &times;</button>';
	echo '<form action="newplaylist.php" method="POST">';
	echo '<table class="w3-table w3-bordered" style="text-align:center">';
	echo '<tr>';
	echo '<td>Playlist Title:</td>';
	echo '<td><input type = "text" name = "ptitle" placeholder="Title" required></td>';
	echo '</tr>';
	echo '<tr>';
	echo '<td>Description:</td>';
	echo '<td><input type = "text" name = "pdesc" placeholder="Description"></td>';
	echo '</tr>';
	echo '<tr><input type = "submit" name = "new_playlist" value = "Create"></tr>';
	echo '</table>';
	echo '</div>';
